                                        ...
                                        <div class="row tglitems" id="<?= $idvalue ?>">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <input type="text" id="countout" value="<?= count($lmitems->data) ?>">
                                                        <?php
                                                            foreach($lmitems->data as $lmtglitems){ ?>
                                                            <div class="row" id="tgl-div-out">
                                                                <div class="col-md-12" style="background:#dedede;padding:15px;border-radius:5px;margin-bottom:10px">
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <input type='button' class="btn btn-info btn-xs" value='+' id='addButton'>
                                                                                <input type='button' class="btn btn-danger" value='-' id='removeButton'>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <input type='button' class="btn btn-info btn-xs" value='tambah tanggal' id='addButton'>
                                                                    <input type='button' class="btn btn-danger" value='hapus tanggal' id='removeButton'>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
  $(document).ready(function(){
    ...
    var counter = $('#countout').val();
    $('#countout').val(counter);
    $("#addButton").click(function(){		
        console.log('pace');

        var newTextBoxDiv1 = $(document.createElement('div')).attr("id", 'TextBoxDiv1' + counter);
        var isi = '<div class="col-md-12" style="background:#dedede;padding:15px;border-radius:5px;margin-bottom:10px">'+
                        '<div class="row">'+
                            '<div class="col-md-4">'+
                                '<div class="form-group">'+
                        ...
                        '<div class="row">'+
                            '<div class="col-md-6">'+
                                '<div class="form-group">'+
                                    '<input type="button" class="btn btn-info btn-xs" value="+">'+
                                    '<input type="button" class="btn btn-danger" value="-">'+
                                '</div>'+
                            '</div>'+
                        '</div>'+
                    '</div>';
        $('#tgl-div-out').append(isi);	
        counter++;
        $('#countout').val(counter);
    });
